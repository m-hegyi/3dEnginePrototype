...
bool Bitmap::Initialize(std::shared_ptr<Graphics> graphics, WCHAR * textureFileName, int bitmapWidth, int bitmapHeight)
{
	m_Graphics = graphics;
...
bool Bitmap::Update(int positionX, int positionY)
{
...
bool Bitmap::LoadTexture(WCHAR * textureFileName)
{
